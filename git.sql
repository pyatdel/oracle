...
INSERT INTO SBOARD (BO_NO, BO_TITLE, BO_WRITER, BO_CONTENT, BO_DATE, BO_HIT, FILE_GROUP_NO)
VALUES (sboard_seq.NEXTVAL, '첫번째 게시글입니다', '홍길동', '안녕하세요. 반갑습니다.', SYSDATE, 0, 'FG001');

INSERT INTO SBOARD (BO_NO, BO_TITLE, BO_WRITER, BO_CONTENT, BO_DATE, BO_HIT, FILE_GROUP_NO)
VALUES (sboard_seq.NEXTVAL, '두번째 게시글입니다', '김철수', '오늘은 날씨가 좋네요!', SYSDATE-1, 5, 'FG002');

INSERT INTO SBOARD (BO_NO, BO_TITLE, BO_WRITER, BO_CONTENT, BO_DATE, BO_HIT, FILE_GROUP_NO)
VALUES (sboard_seq.NEXTVAL, '공지사항입니다', '관리자', '중요한 공지사항이니 꼭 읽어주세요.', SYSDATE-2, 15, 'FG003');

INSERT INTO SBOARD (BO_NO, BO_TITLE, BO_WRITER, BO_CONTENT, BO_DATE, BO_HIT, FILE_GROUP_NO)
VALUES (sboard_seq.NEXTVAL, '질문있습니다', '이영희', '이거 어떻게 하는건가요?', SYSDATE-3, 3, 'FG004');

INSERT INTO SBOARD (BO_NO, BO_TITLE, BO_WRITER, BO_CONTENT, BO_DATE, BO_HIT, FILE_GROUP_NO)
VALUES (sboard_seq.NEXTVAL, '답변드립니다', '박지성', '위 질문에 대한 답변입니다.', SYSDATE-3, 7, 'FG005');
